...
export default function AtividadesCadastradas({ token }) {
    ...
    const handleEditAtividade = async (id) => {
        try {
            ...
            const data = await response.json();
            console.log(data.grupoAtividades);
            
            setSelectedAtividade({
                ...data.grupoAtividades,
                atividades: data.grupoAtividades || [] // Garante que seja sempre um array
            });
                                ...
                                <Card.Body>
                                    <Card.Title style={{ display: 'flex', justifyContent: 'space-between' }}>
                                      ...
                                      <a style={{ border: '1px solid #ccc', 
                                        ...
                                        borderRadius: '5px', 
                                        cursor: 'pointer' }} 
                                        onClick={() => console.log(`apagar atividade ${atividadeIndex + 1} `)}> 🗑 </a>
                                    </Card.Title>
                                                              ...
                                                              <Row style={{ display: 'flex', alignItems: 'center' }}>
                                                                <Col xs={1}>
                                                                  <a style={{ border: '1px solid #ccc', 
                                                                    ...
                                                                    borderRadius: '5px', 
                                                                    cursor: 'pointer' }} 
                                                                    onClick={() => console.log(`Alternativa ${index + 1} excluida`)}>
                                                                         🗑 </a>
                                                                </Col>
                                                                <Col xs={11}>
                                                                  <Row>
